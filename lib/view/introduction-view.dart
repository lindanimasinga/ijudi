...
class _IntroductionViewState extends State<IntroductionView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: LiquidSwipe(
        ...
        slideIconWidget: currentPage == 3 ? IconButton(
  ...
  Container buildStep({int index, String img, String title, String message, Color color}) {
      ...
      child: Stack(
        children: [
          ...
          children: [
            ...
            Text("$index of 4", style: IjudiStyles.HEADER_TEXT, textAlign: TextAlign.center,)
          ],
        ),
      ]
      )
